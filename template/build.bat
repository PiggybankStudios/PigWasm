...
python "..\CombineFiles.py" "%BuildDirectory%\glue_combined.js" "%SourceDirectory%\js\glue_defines.js" "%SourceDirectory%\js\glue_helpers.js" "%SourceDirectory%\js\glue_api.js" "%SourceDirectory%\js\glue.js"

if "%CopyToDataDirectory%"=="1" (
	echo [Copying %ProjectName%.wasm to data directory]
	XCOPY ".\%ProjectName%.wasm" "%DataDirectory%\" /Y > NUL
	XCOPY "%SourceDirectory%\view\index.html" "%DataDirectory%\" /Y > NUL
	XCOPY "%SourceDirectory%\view\main.css" "%DataDirectory%\" /Y > NUL
